...
public class BTGLastOrdersOperandModel extends BTGAbstractOrderOperandModel
{
	 ...
	 */
	@Accessor(qualifier = "lastOrders", type = Accessor.Type.GETTER)
	public Integer getLastOrders()
	{
		return getPersistenceContext().getPropertyValue(LASTORDERS);
	}
	 ...
	 */
	@Accessor(qualifier = "lastOrders", type = Accessor.Type.SETTER)
	public void setLastOrders(final Integer value)
	{
		getPersistenceContext().setPropertyValue(LASTORDERS, value);
	}
