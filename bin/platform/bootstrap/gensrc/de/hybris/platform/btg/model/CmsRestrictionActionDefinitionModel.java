...
public class CmsRestrictionActionDefinitionModel extends BTGOutputActionDefinitionModel
{
	 ...
	 * @return the inverted
	 */
	@Accessor(qualifier = "inverted", type = Accessor.Type.GETTER)
	public Boolean getInverted()
	{
		return getPersistenceContext().getPropertyValue(INVERTED);
	}
	 ...
	 */
	@Accessor(qualifier = "segmentRestrictions", type = Accessor.Type.GETTER)
	public Collection<BtgSegmentRestrictionModel> getSegmentRestrictions()
	{
		return getPersistenceContext().getPropertyValue(SEGMENTRESTRICTIONS);
	}
	 ...
	 */
	@Accessor(qualifier = "inverted", type = Accessor.Type.SETTER)
	public void setInverted(final Boolean value)
	{
		getPersistenceContext().setPropertyValue(INVERTED, value);
	}
	 ...
	 */
	@Accessor(qualifier = "segmentRestrictions", type = Accessor.Type.SETTER)
	public void setSegmentRestrictions(final Collection<BtgSegmentRestrictionModel> value)
	{
		getPersistenceContext().setPropertyValue(SEGMENTRESTRICTIONS, value);
	}
