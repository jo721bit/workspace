...
public class UserModel extends PrincipalModel
{
	 ...
	 */
	@Accessor(qualifier = "conditionResults", type = Accessor.Type.GETTER)
	public Collection<BTGConditionResultModel> getConditionResults()
	{
		return getPersistenceContext().getPropertyValue(CONDITIONRESULTS);
	}
	 ...
	 */
	@Accessor(qualifier = "ruleResults", type = Accessor.Type.GETTER)
	public Collection<BTGRuleResultModel> getRuleResults()
	{
		return getPersistenceContext().getPropertyValue(RULERESULTS);
	}
	 ...
	 */
	@Accessor(qualifier = "segmentResults", type = Accessor.Type.GETTER)
	public Collection<BTGSegmentResultModel> getSegmentResults()
	{
		return getPersistenceContext().getPropertyValue(SEGMENTRESULTS);
	}
	 ...
	 */
	@Accessor(qualifier = "conditionResults", type = Accessor.Type.SETTER)
	public void setConditionResults(final Collection<BTGConditionResultModel> value)
	{
		getPersistenceContext().setPropertyValue(CONDITIONRESULTS, value);
	}
	 ...
	 */
	@Accessor(qualifier = "ruleResults", type = Accessor.Type.SETTER)
	public void setRuleResults(final Collection<BTGRuleResultModel> value)
	{
		getPersistenceContext().setPropertyValue(RULERESULTS, value);
	}
	 ...
	 */
	@Accessor(qualifier = "segmentResults", type = Accessor.Type.SETTER)
	public void setSegmentResults(final Collection<BTGSegmentResultModel> value)
	{
		getPersistenceContext().setPropertyValue(SEGMENTRESULTS, value);
	}
