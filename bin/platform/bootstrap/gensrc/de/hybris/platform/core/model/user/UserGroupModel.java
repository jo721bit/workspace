...
public class UserGroupModel extends PrincipalGroupModel
{
	 ...
	 */
	@Accessor(qualifier = "BTGAssignToGroup", type = Accessor.Type.GETTER)
	public Collection<BTGAssignToGroupDefinitionModel> getBTGAssignToGroup()
	{
		return getPersistenceContext().getPropertyValue(BTGASSIGNTOGROUP);
	}
	 ...
	 */
	@Accessor(qualifier = "BTGAssignToGroup", type = Accessor.Type.SETTER)
	public void setBTGAssignToGroup(final Collection<BTGAssignToGroupDefinitionModel> value)
	{
		getPersistenceContext().setPropertyValue(BTGASSIGNTOGROUP, value);
	}
