package my.bookstore.core.enums;
...
/**
 * Generated enum SwatchColorEnum declared at extension bookstorecore.
 */
...
public class SwatchColorEnum implements HybrisEnumValue
{
	...
	/**
	* Generated enum value for SwatchColorEnum.BLACK declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum BLACK = valueOf("BLACK");
	
	/**
	* Generated enum value for SwatchColorEnum.BLUE declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum BLUE = valueOf("BLUE");
	
	/**
	* Generated enum value for SwatchColorEnum.BROWN declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum BROWN = valueOf("BROWN");
	
	/**
	* Generated enum value for SwatchColorEnum.GREEN declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum GREEN = valueOf("GREEN");
	
	/**
	* Generated enum value for SwatchColorEnum.GREY declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum GREY = valueOf("GREY");
	
	/**
	* Generated enum value for SwatchColorEnum.ORANGE declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum ORANGE = valueOf("ORANGE");
	
	/**
	* Generated enum value for SwatchColorEnum.PINK declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum PINK = valueOf("PINK");
	
	/**
	* Generated enum value for SwatchColorEnum.PURPLE declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum PURPLE = valueOf("PURPLE");
	
	/**
	* Generated enum value for SwatchColorEnum.RED declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum RED = valueOf("RED");
	
	/**
	* Generated enum value for SwatchColorEnum.SILVER declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum SILVER = valueOf("SILVER");
	
	/**
	* Generated enum value for SwatchColorEnum.WHITE declared at extension bookstorecore.
	*/
	public static final SwatchColorEnum WHITE = valueOf("WHITE");
	
	/**
	* Generated enum value for SwatchColorEnum.YELLOW declared at extension bookstorecore.
	*/
