...
public class BTGReferenceKeyValuePairListOperandModel extends BTGAbstractReferenceOperandModel
{
	 ...
	 */
	@Accessor(qualifier = "keyValuePairs", type = Accessor.Type.GETTER)
	public Collection<String> getKeyValuePairs()
	{
		return getPersistenceContext().getPropertyValue(KEYVALUEPAIRS);
	}
	 ...
	 */
	@Accessor(qualifier = "keyValuePairs", type = Accessor.Type.SETTER)
	public void setKeyValuePairs(final Collection<String> value)
	{
		getPersistenceContext().setPropertyValue(KEYVALUEPAIRS, value);
	}
